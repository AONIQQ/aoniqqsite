    ...
    return (
      <button
        ...
        className={cn(
          ...
          "before:z-[1]",
          "before:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2),inset_0_0_16px_0_rgba(36,84,255,0.1),inset_0_-3px_12px_0_rgba(36,84,255,0.15),0_1px_3px_0_rgba(0,0,0,0.50),0_4px_12px_0_rgba(0,0,0,0.45)]",
        ...
        {...props}
        style={{
          "--circle-start": "#0ABF8E", // tealLux
          "--circle-end": "#2454FF",   // royal
